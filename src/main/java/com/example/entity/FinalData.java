...
public class FinalData implements Serializable {
  ...
  public Integer getFundCode() { return fundCode; }

  public void setFundCode(Integer fundCode) { this.fundCode = fundCode; }
  ...
  public String toString() {
    return "FinalData{"
        + "fundCode=" + fundCode + ", fundShortName='" + fundShortName + '\'' +
        ", DateStatistics=" + dateStatistics +
        ", NetValuePerUnit=" + netValuePerUnit + ", NearlyOneWeek='" +
        nearlyOneWeek + '\'' + ", NearlyOneMonth='" + nearlyOneMonth + '\'' +
        ", NearlyThreeMonth='" + nearlyThreeMonth + '\'' + ", NearlyOneYear='" +
        nearlyOneYear + '\'' + ", NearlyTwoYear='" + nearlyTwoYear + '\'' +
